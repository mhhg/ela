...
$class = getAllActiveClass();
$stu = getAllUnAcceptedResults($class);
//$teacher = getTeacher();
...
if (isset($_GET['submit'])) {
	...
	$query = "UPDATE  `elaonlin_elaclass`.`$stuClassTableName` SET  `status` = '2', `PresentCondition` = '$PresentConditionValue', `ClassActivity` = '$ClassActivity', `Speaking` = '$Speaking',  `Midterm` = '$Midterm', `Final` = '$Final', `Total` = '$Total'  WHERE  `id` = '$stid' ;";
...
<html>
	...
	<body>
		<div id="blackbk" style="display: <?php echo $msgvisible; ?>; position: fixed; top: 4.8vh; left: 0px; width: 100%; height: 100%; opacity: .8; background-color: black; z-index: 10">
			<form action="adminResult.php" class="form-horizontal" method="get" role="form">
		...
		<div class="bg-info" style="margin-top: -16px; width: 100%;">
			<div class="bg-primary
			     " style="position: fixed; width: 100%; z-index: 10;">
				<h3 class="text-center"> Set Student's Result,<em> <?php echo $teacher['fn']; ?> </em> </h3>
			</div>
			<form class=" bg-info form-horizontal col-xs-12" style="padding-top: 50px" onsubmit="return validate()" action="adminResult.php" method="get" role="form">
				<div class="row">
					<div class="col-xs-6" >
